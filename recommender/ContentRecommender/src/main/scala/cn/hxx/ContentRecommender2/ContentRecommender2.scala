...
object ContentRecommender2 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        val hashingTF = new HashingTF().setInputCol("words").setOutputCol("rawFeatures").setNumFeatures(250)
...
//        movieFeatures.collect().take(10).foreach(println)
        ...
        val movieRecs = movieFeatures.cartesian(movieFeatures) //笛卡尔积
                ...
                .filter(_._2._2 > 0.5) //过滤出相似度评分大于0.6的
