...
import cn.hxx.OfflineRecommender2.OfflineRecommenderWithLFM2.MONGODB_RATING_COLLECTION
...
object ALSTrainer2 {
    ...
    def adjustALSParam(trainData: RDD[Rating], testData: RDD[Rating]): Unit = {
        val result = for (rank <- Array(5,7,9,11); lambda <- Array(0.00000001,0.0000001,0.000001))
